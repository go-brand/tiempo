 ...
 * @returns The number of minutes between the dates, truncated toward zero (pass { fractional: true } for the precise value)
 *
 * @example
 * ```ts
...
export function differenceInMinutes(
  ...
  const precise = differenceInMilliseconds(zoned1, zoned2) / 60000;
